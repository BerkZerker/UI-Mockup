    ...
    <SafeAreaView style={styles.safe} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={[styles.statsCard, { backgroundColor: theme.glassBackground, borderColor: theme.glassBorder }]}>
          ...
          <View style={styles.stat}>
            <Text style={[styles.statValue, { color: theme.textPrimary }]}>{bestStreak}d</Text>
        ...
        {/* About */}
        <Text style={[styles.sectionTitle, { color: theme.textMuted, marginTop: SPACING.xxxl }]}>ABOUT</Text>
        <View style={[styles.row, { borderBottomColor: theme.borderSubtle }]}>
